...
export const LOCALE = Object.freeze({
  ...
  rest_fallback_desc: pair('Used only when the programme does not prescribe a rest for that exercise. The programme wins when it does.', 'يُستعمل فقط لما البرنامج ما يحدّد راحة لذلك التمرين. إذا حدّدها، البرنامج هو المرجع.'),
  delete_session: pair('Delete this session', 'احذف هذه الجلسة'),
  delete_session_confirm: pair('Delete the session logged on {date}? This cannot be undone.', 'هل تحذف الجلسة المسجّلة في {date}؟ لا يمكن التراجع.'),
  session_deleted: pair('Session deleted.', 'حُذفت الجلسة.'),
  exercise_settings: pair('Exercise settings', 'إعدادات التمرين'),
  equipment_kind: pair('What is it performed on', 'على أي شيء تؤديه'),
  equip_machine: pair('Machine', 'جهاز'),
  equip_plates: pair('Plates', 'أوزان حرة'),
  equip_dumbbells: pair('Dumbbells', 'دمبل'),
  equip_cable: pair('Cable', 'كيبل'),
  equip_bodyweight: pair('Bodyweight', 'وزن الجسم'),
  which_device: pair('Which machine', 'أي جهاز'),
  which_device_hint: pair('60 kg on one leg press is not 60 kg on another. Name the machine and the app keeps its own weight history for it.', '60 كجم على جهاز ليست 60 على غيره. سمِّ الجهاز والتطبيق يحتفظ بسجل أوزانه وحده.'),
  device_placeholder: pair('e.g. Hammer Strength', 'مثلاً: Hammer Strength'),
  ...
  equipment_section: pair('Equipment', 'الجهاز'),
  ...
  log_col_best: pair('Top set', 'أعلى مجموعة'),
  log_col_sets: pair('Sets', 'عدد'),
  log_col_device: pair('Machine', 'الجهاز'),
  coach_context_label: pair('You are on', 'أنت على'),
  coach_context_use: pair('Include this exercise in the search', 'اجعل السؤال عن هذا التمرين'),
  video_add_title: pair('Add a clip', 'أضف مقطعاً'),
  video_none_yet: pair('No clips of your own on this exercise yet.', 'ما فيه مقاطع خاصة بك على هذا التمرين بعد.'),
  video_count: pair('{n} of your clips', '{n} من مقاطعك'),
  video_duplicate: pair('That clip is already on this exercise.', 'هذا المقطع موجود على التمرين أصلاً.'),
  video_saved_local: pair('Saved on your phone. Syncing…', 'حُفظ على جوالك. جارٍ المزامنة…'),
  video_saved_synced: pair('Saved and synced to your server.', 'حُفظ وتزامن مع خادمك.'),
  video_saved_pending: pair('Saved on your phone. It will sync when your server is reachable.', 'حُفظ على جوالك. سيتزامن أول ما يوصل خادمك.'),
  add: pair('Add', 'أضف'),
  remove: pair('Remove', 'احذف'),
  ramp_short: pair('warm', 'تدرّج'),
  back_to_warmup: pair('← Warm-up', '→ الإحماء'),
