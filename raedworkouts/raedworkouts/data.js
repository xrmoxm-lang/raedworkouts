...
const EXERCISES = [
  // ====== UPPER BODY — PUSH ======
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=incline+chest+press+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=pec+deck+jeff+nippard',
  ...
  },
  {
    ...
    pattern: 'horizontal_push',
    mohannad: [],
    jeff_nippard: 'https://www.youtube.com/results?search_query=incline+dumbbell+press+jeff+nippard',
  ...
  },
  {
    ...
    pattern: 'isolation_push',
    mohannad: [],
    jeff_nippard: 'https://www.youtube.com/results?search_query=cable+fly+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=lateral+raise+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=cable+lateral+raise+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=tricep+dip+machine+jeff+nippard',
  ...
  },
  {
    ...
    pattern: 'isolation_push',
    mohannad: [],
    jeff_nippard: 'https://www.youtube.com/results?search_query=tricep+pushdown+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=overhead+tricep+extension+jeff+nippard',
    alternatives: ['tricep_pushdown'],
  ...
  // ====== UPPER BODY — PULL ======
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=lat+pulldown+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=neutral+grip+pulldown+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=t+bar+row+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=seated+row+machine+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=seated+cable+row+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=reverse+pec+deck+jeff+nippard',
  ...
  // ====== LOWER BODY ======
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=leg+press+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=leg+extension+jeff+nippard',
    alternatives: [],
  ...
  },
  {
    ...
    pattern: 'isolation_hamstring',
    mohannad: [],
    jeff_nippard: 'https://www.youtube.com/results?search_query=seated+leg+curl+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=hip+thrust+jeff+nippard',
    alternatives: ['rdl'],
  ...
  },
  {
    ...
    pattern: 'compound_hinge',
    mohannad: [],
    jeff_nippard: 'https://www.youtube.com/results?search_query=romanian+deadlift+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=standing+calf+raise+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=seated+calf+raise+jeff+nippard',
  ...
  },
  {
    ...
    jeff_nippard: 'https://www.youtube.com/results?search_query=ab+crunch+jeff+nippard',
    alternatives: [],
