...
async function sourceData() {
  ...
  const plan = [rw.PROGRAMME, rw.PROGRAMME_PPL].map((programme) => ({
...
<style>
  :root{--bg:#f4f8f8;--card:#ffffff;--elev:#eaf1f1;--line:#d3e0e0;--ink:#0c1618;--muted:#5b7176;--teal:#0a7d6c;--good:#12805a;--warn:#8a5a05;--bad:#a33232;--field:#ffffff;--on-teal:#ffffff}
  @media(prefers-color-scheme:dark){:root:not([data-theme="light"]){--bg:#07090b;--card:#11161b;--elev:#192126;--line:#273238;--ink:#edf6f5;--muted:#98a8ad;--teal:#2ee6c5;--good:#49d597;--warn:#f2b544;--bad:#ff7e7e;--field:#0c1114;--on-teal:#052a23}}
  :root[data-theme="dark"]{--bg:#07090b;--card:#11161b;--elev:#192126;--line:#273238;--ink:#edf6f5;--muted:#98a8ad;--teal:#2ee6c5;--good:#49d597;--warn:#f2b544;--bad:#ff7e7e;--field:#0c1114;--on-teal:#052a23}
...
await writeFile(resolve(repository, 'dashboard.html'), html, 'utf8');
