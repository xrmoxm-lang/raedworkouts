...
- Name: superset.spec.mjs >> a row whose sets share a target still reads as one word
- Location: tests/superset.spec.mjs:172:1

# Error details

```
Error: page.evaluate: TypeError: Cannot read properties of null (reading 'exercises')
    at eval (eval at evaluate (:302:30), <anonymous>:4:33)
