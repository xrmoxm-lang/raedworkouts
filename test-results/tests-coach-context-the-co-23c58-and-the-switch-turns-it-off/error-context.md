...
- generic [active] [ref=e1]:
  ...
  - main [ref=e17]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e21]:
        - generic [ref=e22]: أنت على Chest Press Machine
        - generic [ref=e23] [cursor=pointer]:
          - checkbox "اجعل السؤال عن هذا التمرين" [checked] [ref=e24]
          - generic [ref=e25]: اجعل السؤال عن هذا التمرين
      - generic [ref=e26]:
        - generic [ref=e27]: ابحث في كتبك التي تملكها. تصلك المقاطع نفسها، ومعها اسم الكتاب والصفحة.
        - generic [ref=e28]:
          - textbox "اسأل عن التمرين أو التغذية…" [ref=e29]: كم راحة
          - button "ابحث" [ref=e30] [cursor=pointer]
      - generic [ref=e31]: مقطع واحد من كتبك
      - article [ref=e32]:
        - generic [ref=e33]:
          - strong [ref=e34]: W
          - generic [ref=e35]: · صفحة 1
        - paragraph [ref=e36]: x
      - paragraph [ref=e37]: منقول من كتبك. لا شيء هنا من تأليف التطبيق.
  - navigation [ref=e38]:
    - button "الرئيسية" [ref=e39] [cursor=pointer]:
      - img [ref=e41]
      - generic [ref=e45]: الرئيسية
    - button "المكتبة" [ref=e46] [cursor=pointer]:
      - img [ref=e48]
      - generic [ref=e51]: المكتبة
    - button "السجل" [ref=e52] [cursor=pointer]:
      - img [ref=e54]
      - generic [ref=e57]: السجل
    - button "المدرب الذكي" [ref=e58] [cursor=pointer]:
      - img [ref=e60]
      - generic [ref=e62]: المدرب
    - button "الإعدادات" [ref=e63] [cursor=pointer]:
      - img [ref=e65]
      - generic [ref=e69]: الإعدادات
  - generic: بدأت الجلسة.
```
